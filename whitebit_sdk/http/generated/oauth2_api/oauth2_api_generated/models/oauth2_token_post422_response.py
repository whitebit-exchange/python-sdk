...
class Oauth2TokenPost422Response(BaseModel):
    """
    Oauth2TokenPost422Response
    """ # noqa: E501
    errors: Optional[Oauth2TokenPost422ResponseErrors] = None
    notification: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["errors", "notification"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "errors": Oauth2TokenPost422ResponseErrors.from_dict(obj["errors"]) if obj.get("errors") is not None else None,
