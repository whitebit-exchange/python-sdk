...
class ApiV4PublicPlatformStatusGet200Response(BaseModel):
    """
    ApiV4PublicPlatformStatusGet200Response
    """ # noqa: E501
    status: Optional[StrictStr] = Field(default=None, description="1 - system operational, 0 - system maintenance")
