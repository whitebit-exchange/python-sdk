...
class AssetProviders(BaseModel):
    """
    Fiat currency providers
    """ # noqa: E501
    deposits: Optional[List[StrictStr]] = None
    withdraws: Optional[List[StrictStr]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["deposits", "withdraws"]
