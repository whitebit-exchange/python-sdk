...
class CreateCollateralTriggerMarketOrderResponse(UniversalBaseModel):
    ...
    side: typing.Optional[CreateCollateralTriggerMarketOrderResponseSide] = pydantic.Field(default=None)
    """
    Order side
    """
    ...
    status: typing.Optional[CreateCollateralTriggerMarketOrderResponseStatus] = pydantic.Field(default=None)
    """
    Order status
    """
    ...
    oto: typing.Optional[CreateCollateralTriggerMarketOrderResponseOto] = pydantic.Field(default=None)
    """
    OTO order data when stopLoss or takeProfit is specified
    """

    position_side: typing_extensions.Annotated[
        typing.Optional[CreateCollateralTriggerMarketOrderResponsePositionSide], FieldMetadata(alias="positionSide")
