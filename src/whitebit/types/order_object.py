...
class OrderObject(UniversalBaseModel):
    """
    ...
    stp: typing.Optional[OrderObjectStp] = pydantic.Field(default=None)
    """
    ...
    position_side: typing.Optional[OrderObjectPositionSide] = pydantic.Field(default=None)
    """
